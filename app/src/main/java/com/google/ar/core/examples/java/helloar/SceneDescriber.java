...
public class SceneDescriber {
  ...
  private static final String SYSTEM_PROMPT =
      "You are the eyes of a blind person wearing a camera on their chest or forehead. "
          ...
          + "Name the thing they would WALK INTO, not the most interesting thing in the picture. "
          + "Ignore anything sitting on top of furniture: a mouse on a table is not an obstacle, "
          + "the table is. Ignore anything on a wall, anything through a window, and anything "
          + "behind glass. Prefer whatever is largest and closest to the middle of the picture. "
